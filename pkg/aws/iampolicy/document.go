...
type Condition struct {
	StringLike                map[string]interface{} `json:",omitempty"`
	StringNotLike             map[string]interface{} `json:",omitempty"`
	StringEquals              map[string]interface{} `json:",omitempty"`
	StringNotEquals           map[string]interface{} `json:",omitempty"`
	StringEqualsIgnoreCase    map[string]interface{} `json:",omitempty"`
	StringNotEqualsIgnoreCase map[string]interface{} `json:",omitempty"`
}
